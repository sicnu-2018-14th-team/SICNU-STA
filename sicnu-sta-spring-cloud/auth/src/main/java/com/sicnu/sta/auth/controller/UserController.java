...
import com.sicnu.sta.auth.service.UserServiceImpl;
...
public class UserController {
    ...
    public ResultUtils<Object> studentJoinTheClass(@RequestParam("classId") Integer classId) {
        LoginUser loginUser = (LoginUser) SecurityUtils.getSubject().getPrincipal();
    ...
    public ResultUtils<Object> sendEmail(@RequestParam(value = "email") String emailAddress) {
        return userService.sendEmailVerCode(emailAddress);
    }
