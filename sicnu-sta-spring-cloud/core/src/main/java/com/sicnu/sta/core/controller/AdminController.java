...
import com.sicnu.sta.core.service.impl.AdminServiceImpl;
...
public class AdminController {
    ...
    public ResultUtils<Object> queryMyCreateProblem(@RequestParam("typeId") Integer typeId,
    ...
    public ResultUtils<Object> queryMyCreateContest(@RequestParam("pageSize") Integer pageSize,
                                                    @RequestParam("page") Integer page) {
        LoginUser loginUser = (LoginUser) SecurityUtils.getSubject().getPrincipal();
    ...
    public ResultUtils<Object> queryMyCreateClass(@RequestParam("pageSize") Integer pageSize,
                                                  @RequestParam("page") Integer page) {
        LoginUser loginUser = (LoginUser) SecurityUtils.getSubject().getPrincipal();
    ...
    public ResultUtils<Object> queryProblemInfo(@RequestParam("problemId") Integer problemId) {
