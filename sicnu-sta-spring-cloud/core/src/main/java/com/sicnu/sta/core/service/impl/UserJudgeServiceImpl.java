...
import com.sicnu.sta.core.service.UserJudgeService;
...
public class UserJudgeServiceImpl implements UserJudgeService {
    ...
    public ResultUtils<Object> submitProgramProblem(SubmitProgram submitProgram) {
        try {
            System.out.println(submitProgram);
            ...
            if (submitProgram.getSubmitId() > 0) {
                ...
                Map<String, List<String>> data = AdminProblemServiceImpl.readTestCase(UPLOAD_FOLDER + uuid + "/1/");
