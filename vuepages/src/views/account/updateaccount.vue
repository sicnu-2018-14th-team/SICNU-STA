        ...
        <div style="float: left; margin-left: 10px;">
            ...
            <el-form :model="registerForm" :rules="rules" ref="registerForm" label-width="50px" class="demo-registerForm">
                ...
                <el-form-item prop="password1">
                    ...
                    <el-input class="el-input-wid" v-model="registerForm.password1" placeholder="新密码" type="password"
                ...
                <el-form-item prop="password2">
                    ...
                    <el-input class="el-input-wid" v-model="registerForm.password2" placeholder="重复新密码" type="password"
                ...
                <el-form-item style="margin-left: 15%;">
                    <el-button type="primary" @click="submitForm('registerForm')">修改密码</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            submit(email, password) {
                ...
                axios.post(this.global.user_update_password, this.$qs.stringify({
                    "email": email,
                    "password": password}
                )).then((response) => {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    ...
                    if (valid) {
                        ...
                        this.submit(this.registerForm.email, this.registerForm.password1);
                    } else {
